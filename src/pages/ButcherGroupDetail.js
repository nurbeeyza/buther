...
const ButcherGroupDetail = () => {
  ...
  const products = {
    ...
    2: {
      ...
      description:
        "Yumuşacık dana jülyen, ızgara ve tavada pişirme için ideal.",
      features: [
    ...
    5: {
      ...
      description:
        "Premium dana kontrfile, steak ve ızgara için mükemmel seçim.",
      features: [
        "Premium steak eti",
        "Mükemmel marbling",
        "Yumuşak doku",
    ...
    >
      ...
      <div className="detail-main-grid">
        ...
        <div>
          ...
          >
            <strong style={{ color: "var(--primary-color)" }}>Birim:</strong>{" "}
            {product.weight}
          </div>
