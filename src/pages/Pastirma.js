...
const Pastirma = () => {
  console.log("Pastirma component loaded!");
  ...
  const products = [
    {
      ...
      description:
        "Geleneksel Başpınarlar pastırması, özel baharatlarla hazırlanmıştır.",
    },
    {
      id: 2,
      name: "Dilim Pastırma",
    ...
    >
      ...
      >
        {products.map((product) => (
          <Link
            key={product.id}
            to={`/products/pastirma/${product.id}`}
