...
const PrivacySecurity = () => (
  <>
    <div style={{ background: '#111', color: '#fff', padding: '4rem 0', textAlign: 'center', marginBottom: '2rem', width: '100vw', position: 'relative', left: '50%', right: '50%', marginLeft: '-50vw', marginRight: '-50vw', marginTop: '7rem', zIndex: 0 }}>
      <h1 style={{ color: '#fff', fontSize: 36, fontWeight: 800, letterSpacing: 1, textShadow: '0 2px 8px #000', margin: 0 }}>Gizlilik ve Güvenlik</h1>
    </div>
    <div style={sectionStyle}>
      ...
      <h2 style={subHeadingStyle}>Mail Order Kredi Kartı Bilgileri Güvenliği</h2>
      <p style={paragraphStyle}>
      ...
      <ul style={{ fontSize: 18, marginBottom: 18, marginLeft: 24, color: "#222" }}>
      ...
      <div style={contactBoxStyle}>
        <b>Gizlilik politikamız ile ilgili her türlü soru ve önerileriniz için <a href="mailto:info@baspinarlaret.com" style={{ color: '#800020', textDecoration: 'underline' }}>info@baspinarlaret.com</a> adresine email gönderebilirsiniz.</b><br /><br />
        <b>Firma Ünvanı:</b> BAŞPINARLAR HAYVANCILIK GIDA RESTORAN SAN VE TİC. LMTD.Ş.<br />
        <b>Adres:</b> 75.Yıl Mh. ESTİM Toptancılar Sitesi H Blok No:21 ODUNPAZARI ESKİŞEHİR<br />
        <b>Eposta:</b> info@baspinarlaret.com<br />
