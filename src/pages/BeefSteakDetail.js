...
const BeefSteakDetail = () => {
  ...
  const products = {
    1: {
      ...
      description:
        "Premium kalite Dallas steak, özel kesim ve marinasyon ile hazırlanmıştır.",
      detailedDescription:
        "Dallas Steak, Amerika'nın en ünlü steak çeşitlerinden biridir. Özel olarak seçilmiş dana etinin en kaliteli bölümlerinden elde edilen bu steak, yumuşaklığı ve lezzeti ile ünlüdür. Uzman kasaplarımız tarafından özenle kesilir ve özel marinasyon işleminden geçirilir.",
      features: [
    ...
    2: {
      ...
      description:
        "Yumuşacık dana antrikot, ızgara ve tavada pişirme için ideal.",
      detailedDescription:
        "Dana antrikot, dana etinin en lezzetli ve yumuşak bölümlerinden biridir. Kaburga kemiği çevresinden alınan bu özel kesim, marbling (yağ damarları) yapısı sayesinde pişirme sırasında kendiliğinden yumuşar ve eşsiz bir lezzet sunar.",
      features: [
    ...
    3: {
      ...
      detailedDescription:
        "Dana Asado, Arjantin mutfağından gelen özel bir kesim tekniğidir. Kalın kesilmiş bu et parçası, uzun ve yavaş pişirme için idealdir. Mangal kültürünün vazgeçilmez parçası olan asado, sosyal yemeklerin ve özel günlerin yıldızıdır.",
      features: [
    ...
    4: {
      ...
      detailedDescription:
        "Dana bonfile, dana etinin en değerli ve yumuşak bölümüdür. Hayvanın en az çalışan kasından alınan bu özel kesim, eşsiz yumuşaklığı ve lezzeti ile fine dining restoranlarının favorisidir. Minimal yağ oranı ve maksimum protein içeriği ile sağlıklı beslenmenin de vazgeçilmezidir.",
      features: [
    ...
    5: {
      ...
      detailedDescription:
        "Dana kemikli kaburga, geleneksel Türk mutfağının vazgeçilmez lezzetlerinden biridir. Kemik içindeki ilik ve et arasındaki bağ dokular, uzun pişirme sürecinde eşsiz bir lezzet ve aroma oluşturur. Haşlama, güveç ve fırın yemekleri için mükemmeldir.",
      features: [
    ...
    6: {
      ...
      detailedDescription:
        "Dana pirzola, kaburga kemiği ile birlikte kesilmiş özel bir dana eti kesimdir. Kemik sayesinde pişirme sırasında ete özel bir lezzet katar. Izgara ve tavada pişirme için ideal olan pirzola, hem pratik hem de lezzetli bir seçenektir.",
      features: [
        "Kemikli özel kesim",
        "Izgara için ideal",
        "Pratik pişirme",
    ...
    7: {
      ...
      detailedDescription:
        "T-Bone steak, dünya mutfağının en ünlü steak çeşitlerinden biridir. T şeklindeki kemiğin bir tarafında bonfile, diğer tarafında kontrfile bulunur. Bu sayede iki farklı et dokusunu aynı anda tadabilirsiniz. Amerikan mutfağının klasik temsilcisidir.",
      features: [
